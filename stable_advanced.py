...
sum = 0
dataframe = {}
position = {"type":"S","entry_price":"","entry_date":"","exit_price":"","exit_date":""}
...
class Strategy():
    ...
    def process(self):
        global last_entry_price,last_exit_price,low,sum,dataframe
        ...
        for i in dataframe.index:            
            ...
            if position['type'] == "B":
                low = self.exit_position( d, l, e)

            elif position['type'] == "S":        
                self.entry_position( d, o, l, v, e)
    ...
    def entry_position(self, d, o, l, v, e):
        global buy_counter,last_entry_price,last_exit_price,sum,dataframe,low,position
        if e == low:
    ...
    def exit_position(self, d, l, e):
        global sell_counter,sum,position
        global low
    ...
    def dataframe_init(self):
        df1 = pd.read_csv(f'./data/bybit/{self.instrument}/data_2D_20230701_1m_price_pump_after_buy.csv',delimiter=',')
